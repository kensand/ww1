...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    //verdun
        ...
        h = document.createElement("h6");
        h.appendChild(document.createTextNode("Ypres"));
        msection.appendChild(h);
        mchap.appendChild(msection);
    ...
    mchap = document.createElement("div");
        ...
        label.id = "About";
        label.className = "navLabel";
        label.setAttribute("href", "../home/about.html");
        h = document.createElement("h6");
        ...
        label.id = "References";
        label.className = "navLabel";
        label.setAttribute("href", "../home/references.html");
        h = document.createElement("h6");
        h.appendChild(document.createTextNode("References"));
        label.appendChild(h);
        nav.appendChild(label);
    ...
    test.onclick = test.open = function(){console.log("click");window.location="../media/final.html";};
	    ...
	    references.close = function(){return false;}
	    references.onclick = references.open = function(){window.location="../home/references.html";};
